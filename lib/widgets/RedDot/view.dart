// 代码来源于https://github.com/wanglu1209/WFlutterDemo/blob/master/wx_demo_project/lib/red_dot_page.dart
import 'dart:math';
...
class RedDotPage extends StatefulWidget {
  ...
  const RedDotPage({Key? key, required this.startPosition, required this.endPosition})
      : super(key: key);
...
class _RedDotPageState extends State<RedDotPage>
  ...
  void initState() {
    ...
    var x1 = widget.startPosition.dx - 50;
    var y1 = widget.startPosition.dy - 300;
